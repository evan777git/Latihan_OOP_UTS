...
fun main() {
    ...
    val (userName, userAge) = data1 // Destructuring Declaration -> membongkar isi object jadi variabel terpisah satu per satu
    println("Destructured: $userName berumur $userAge")

    println("\n=== TEST SEALED CLASS ===")
    val response: ApiResponse = ApiResponse.Success("Data berhasil ditarik!")

    // ERROR: 'when' expression must be exhaustive -> Semua kemungkinan dari ApiResponse harus ditangani
